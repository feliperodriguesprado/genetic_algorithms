...
function FormatValue(value, format) {
    ...
    if (format === undefined) {
        ...
        try {
            ...
            window.console.error('Carregar script numeral.min.js e languages.min.js de Numeraljs no HTML para formatação correta dos valores: ' +
                                 '\n<script type="text/javascript" src="numeral.min.js"></script>' +
                                 '\n<script type="text/javascript" src="languages.min.js"></script>');
